...
/**
 * Calculates the Multivariate-Gaussian probability density
 * @param sig_x standard deviation in the x range
 * @param sig_y standard deviation in the y range
 * @param x_obs x observation in map coordinates from the landmarks
 * @param y_obs y observation in map coordinates from the landmarks
 * @param mu_x x coordinate of the nearest landmarks
 * @param mu_y y coordinate of the nearest landmarks
 */ 
inline double multiv_prob(double sig_x, double sig_y, double x_obs,
